...
const BRAILLE_RE = /^[\s\p{Script=Braille}]+$/u;
...
class SaneTwitchChat {
  #userName = null;
  #prevMessage = null;
  #fastChatCache = new lru_cache_raw__WEBPACK_IMPORTED_MODULE_0__/* .LRUCache */ .q({
    max: FAST_CHAT_CACHE_SIZE,
    ttl: FAST_CHAT_CACHE_TIMEOUT,
    updateAgeOnGet: true,
    ttlResolution: 100
  });
  #longChatCache = new lru_cache_raw__WEBPACK_IMPORTED_MODULE_0__/* .LRUCache */ .q({
  ...
  #watchChatMessages() {
    document.arrive(CHAT_SEL, chatNode => {
      ...
      chatNode.arrive(CHAT_LINE_SEL, msgNode => {
        ...
        const xpathResult = this.#chatLineXpath.evaluate(msgNode, XPathResult.ORDERED_NODE_ITERATOR_TYPE);
        const fragments = [];
...
async function start() {
  ...
  try {
    if (cookies === undefined) {
      const name = js_cookie__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get('login');
      if (name !== undefined) {
        cookies = [{
          value: name
        }];
...
;// ./node_modules/lru-cache/dist/esm/browser/diagnostics-channel.js
...
/******/ 	let __webpack_exports__ = __webpack_require__(402);
/******/ 	
/******/ })()
;
//# sourceMappingURL=index.js.map